...
<head>
  ...
  <title>Patient Record Deletion Page</title>
...
<%	  
 ...
 try 
	{		
				...
				{
				%> 
								<h5 align="center" class="style12"> Your Data Deleted Succesfully. </h5>
								<p>&nbsp;</p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
         ...
         <li><strong><a href="p_profile.jsp"> My Profile </a></strong></li>
			...
			<li><strong><a href="p_delete_data.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View and Delete My Details </a></strong></li>
