...
<head>
  ...
  <title>Patient Reports Page</title>
 ...
 <a class="btn-getstarted" href="javascript:history.back();">Back</a>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center"> View All My Collected Data (Reports)  </h2>
...
<%
								...
								else
								{
									String query="select * from cloudlet_files where pname='"+pname+"' and upload_by='Device' "; 
							   		...
							   		if(!rs1.next()){
							   			%>%><br> <h5 align="center" class="style15 style7 style8 style11"> There Are No Reports Of You!<br>You Have To Visit Our Hospital<br> And Fill The Form Manually! </h5> <%
							   		}
...
<%
	  ...
	  j=j+1;}
							...
							{
							%><br> <h5 align="center" class="style15 style7 style8 style11"> You Have Not Requested to Access Your Data. </h5> 
<%
							}
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
         ...
         <li><strong><a href="p_profile.jsp"> My Profile </a></strong></li>
			...
			<li><strong><a href="p_my_dat_to_doc_new.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> Access My Data and Send To Doctor </a></strong></li>
