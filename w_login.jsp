      ...
      <div class="mainbar">
        <div class="article">
            <div class="signin-form">
                      ...
                      <form action="w_authentication.jsp" method="post"><div class="clr"></div>
                      </div></div>
   ...
   <center>   <button type="submit" class="btn btn-primary">Login</button>
      ...
      <div class="sidebar">
        <div class="searchform">
          <form id="formsearch" name="formsearch" method="post" action="w_authentication.jsp">
            <span>
        ...
        <div class="gadget">
          ...
          <li><a href="d_login.jsp"><span>Doctor</span></a></li>
          <li><a href="p_login.jsp"><span>Patient</span></a></li>
          <li><a href="w_login.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"><span>Hospitals</span></a></li> 
		  <li><a href="i_login.jsp"><span>Intruder</span></a></li>
          </ul>
        </div>
        <div class="gadget">
