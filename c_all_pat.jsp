    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
       <table width="610" border="1.5" cellpadding="0" cellspacing="0" align="center" class="tab">
         <tr bgcolor="#00FF33">
...
%>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu" >
         <li><strong><a href="c_all_pat.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View All Patients and Authorize </a></strong></li>
