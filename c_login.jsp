      ...
      <div class="mainbar">
        <div class="article">
            <div class="signin-form">
                        <h2 class="form-title">Cloud Sign In</h2>
                      <form action="c_authentication.jsp" method="post"><div class="clr"></div>
                      </div></div>
...
<button type="reset" class="btn btn-primary">Reset</button></center> 
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu" >
           <li><a href="c_login.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"><span>Healthcare Cloud</span></a></li>
          <li><a href="d_login.jsp"><span>Doctor</span></a></li>
          <li><a href="p_login.jsp"><span>Patient</span></a></li>
          <li><a href="w_login.jsp"><span>Hospitals</span></a></li> 
		  <li><a href="i_login.jsp"><span>Intruder</span></a></li>
