...
table {
  ...
  box-shadow: 0 0 15px rgba(0, 123, 255, 0.5); /* Soft blue shadow */
}
...
/* Apply border radius only to the first and last cells */
th:first-child {
...
%>
      ...
      <div class="sidebar">
       ...
       <li><a href="w_pat_to_cloud.jsp"> Collect Patient Data and Upload to Healthcare Cloud</a></li>
            <li><a href="w_pat_data.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View All Patients Collected Data </a></li>
