...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from patients where name='"+uname+"'"; 
...
window.location.href="p_registration.jsp";
<!--

//-->
</script>
		<!-- 					<p><a href="p_register.jsp">Back</a>         </p>
					   ...
					   {
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into patients(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													//out.println("Sucessfully Registered as Patient ");							
							
			%>
			<script >
alert("Patient Registred Sucessfully")
