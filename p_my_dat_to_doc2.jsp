...
try {
		...
		int id = Integer.parseInt(request.getParameter("id"));
			...
			%>					
			<script>alert("You Have Already Sent This Report Details To This Doctor");
			window.location.href="p_my_dat_to_doc_new.jsp"</script>
...
int x=ps.executeUpdate();
			...
			%>
			<script>alert("Details Sent to Doctor Successfully");
			window.location.href="p_my_dat_to_doc_new.jsp";</script>
