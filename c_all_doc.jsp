      ...
      <div class="sidebar">
        ...
        <div class="gadget">
         ...
         <li><strong><a href="c_all_pat.jsp"> View All Patients and Authorize </a></strong></li>
            <li><strong><a href="c_all_doc.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View All Doctors and Authorize </a></strong></li>
