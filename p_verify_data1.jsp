...
<head>
  ...
  <title>Patient Data Verification Page</title>
 ...
 try 
	{		
					   		...
					   		if ( rs.next() ) 
			                {
								...
								{
								%> 
								<h5 align="center" class="style12"> Your Data Has Been Verified And is Found To Be Good. </h5>
								<p>&nbsp;</p>
...
<%
								...
								{
								%> 
								<h5 align="center" class="style15 style7 style8 style11"> Your data has been verified and compromised by an unauthorized entity.</h5>
								<p>&nbsp;</p>
								<p align="center"><a href="p_verify_data2.jsp?id=<%=id%>" class="btn btn-primary">Recover Data</a></p> 
								<p>&nbsp;</p>
								<p>&nbsp;</p>
								<p align="right"><a href="p_verify_data.jsp" class="style6">Back</a></p>  
<%
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
         ...
         <li><strong><a href="p_profile.jsp"> My Profile </a></strong></li>
			...
			<li><strong><a href="p_verify_data.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> Verify My Data and Recover </a></strong></li>
