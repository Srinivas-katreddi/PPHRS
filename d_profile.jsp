...
.btn-getstarted:hover {
  ...
  align-items: center;
  position: absolute;
  bottom: 40px; /* Increased from 20px to 10px */
  left: 50%;
...
<body class="index-page">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
 <h2 align="center"> <%=application.getAttribute("doc")%> Profile <span class="style6"></span> </h2>
<div class="clr"></div>

<center>
    <table width="570" height="395" align="center" cellpadding="0" cellspacing="0" style="width:90px;">
        ...
        <%
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    s5 = rs.getString(5); // Mobile
                    s6 = rs.getString(6); // Address
                    s7 = rs.getString(7); // DOB
                    s8 = rs.getString(8); // Gender
                    s9 = rs.getString(9); // Pincode
                    s10 = rs.getString(10); // Location
                    s11 = rs.getString(11); // Image
                    s12 = rs.getString(12); // Status
        %>

        <tr>
            <td width="45" rowspan="15">
                <input name="image" type="image" src="p_Pic.jsp?id=<%=i%>"
                    style="width:150px; height:100px; margin-top:70px; margin-right: -40px;margin-top:-95px;transform: translateY(10%); padding-left:40px;" />
            </td> 
        </tr> 

        <tr>
            <th style="text-align: center; width: 30%; transform: translateX(-10px);"><b>Field Name</b></th>
            <th style="text-align: center; width: 30%; transform: translateX(-100px);"><b>Value</b></th>
        </tr>

        <div class="left">
            <tr> 
                <td style="padding-left: 80px;"><b>Name:</b></td>
                <td><%=s2%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px;"><b>E-Mail:</b></td>
                <td><%=s4%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px;"><b>Mobile:</b></td>
                <td><%=s5%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px;"><b>Location:</b></td>
                <td><%=s10%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px;"><b>Date of Birth:</b></td>
                <td><%=s7%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px; " class="address"><b>Address:</b></td>
                <td><%=s6%></td> 
            </tr> 
            <tr>
                <td style="padding-left: 80px;" class="gender"><b>Gender:</b></td>
                <td><%=s8%></td>
            </tr>
            <tr>
                <td style="padding-left: 80px;" class="pincode"><b>Pincode:</b></td>
                <td><%=s9%></td>
            </tr>
            <tr>
                <td style=""class="status"><b>Status:</b></td>
                <td><%=s12%></td>
            </tr>
        </div>
