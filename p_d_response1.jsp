...
<head>
  ...
  <title>Patient Medical Prescription Details Page</title>
...
<table width="640" border="1" align="center" cellspacing="0" cellpadding="10">
	  ...
	  <tr>
	      <td height="52" colspan="2" align="center" bgcolor="#666666" style="background:#007bff;color:white;font-size:16px;"> <span class="style16">Sent Report</span> </td>
	  </tr>
	  ...
	  <tr>
	      <td height="52" colspan="2" align="center" bgcolor="#666666" style="background:#007bff;color:white;font-size:16px;"> <span class="style16">Medicine Solution</span> </td>
	  </tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
         ...
         <li><strong><a href="p_profile.jsp"> My Profile </a></strong></li>
			...
			<li><strong><a href="p_d_response.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View Doctor Response with Medical Prescription </a></strong></li>
