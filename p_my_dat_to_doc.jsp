...
<head>
  ...
  <title>Patient Data To Doctor Page</title>
...
<table width="647" border="1" align="center" cellspacing="0" cellpadding="10">
	  ...
	  <tr>
	      <td height="52" colspan="2" align="center" bgcolor="#666666" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"><a href="p_my_dat_to_doc1.jsp?id=<%=i%>" class="style8"> Send Data to Doctor </a></td>
	  </tr>
