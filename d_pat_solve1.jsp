...
<table width="620" border="1" align="center" cellspacing="0" cellpadding="10">
 ...
 color:white;"><a href="d_pat_solve2.jsp?pid=<%=i%>" class="style8"> Give Solution </a></td>
	  </tr>
...
%>							
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu" >
            <li><a href="d_pat_solve.jsp" style="boder:20px solid var(--accent-color);
  background-color: color-mix(in srgb, var(--accent-color), black 20%);
 color:white;"> View Patient Details and Give Solution </a></li>
