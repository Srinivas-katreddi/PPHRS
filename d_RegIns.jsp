...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from doctors where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
							...
							window.location.href="d_registraion.jsp";
							</script>
							<!-- <p><a href="d_register.jsp">Back</a>         </p>
					   ...
					   {
					String str="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into doctors(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
													...
													//out.println("Sucessfully Registered as Doctor ");							
							
			%>
			<script>
							alert("Sucessfully Registered As Doctor!");
							window.location.href="d_login.jsp";
							</script>
